...
#convert HSID in metadata to character
metadata_to_use$HSID <- as.character(metadata_to_use$HSID)


#plot
ggplot(data = unmapped_only, aes(x= reorder(HSID, total_rel_abun),y=total_rel_abun, fill=sample_type)) +
  geom_bar(stat = "identity") +
  facet_wrap(~tax_id, scales = "free") + 
  labs(y= "% relative abundance", x="sample id")+
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 45, color = "black", size = 7, hjust = 1, vjust = 1),
